...
%x = 100*1e-12*cos(2*pi*f1*t) + 15*1e-12*cos(3*2*pi*f1*t) + 9*1e-12*cos(5*2*pi*f1*t);

%s = 100*cos(2*pi*f1*t) + 18*cos(5*2*pi*f1*t) + 12*cos(7*2*pi*f1*t);
%x = awgn(s,50,'measured');

%x = 100*1e-12*cos(2*pi*f1*t) + 11*1e-12*cos(0.6*2*pi*f1*t) + 4*1e-12*cos(3*2*pi*f1*t);

%x = 80*1e-12*cos(2*pi*f1*t) + 10*1e-12*cos(1.5*2*pi*f1*t) + 8*1e-12*cos(3*2*pi*f1*t) + 4*1e-12*cos(4.44*2*pi*f1*t); 

%x = 100*1e-12*cos(2*pi*f1*t) + 12*1e-12*cos(3*2*pi*f1*t) + 6*1e-12*cos(5*2*pi*f1*t) + 8*1e-12*cos(7*2*pi*f1*t) + 5*1e-12*cos(9*2*pi*f1*t) + 2*1e-12*cos(0.52*2*pi*f1*t)+ 4*1e-12*cos(3.6*2*pi*f1*t)+ 5*1e-12*cos(4.6*2*pi*f1*t);

%x = 100*1e-12*cos(2*pi*f1*t) + 10*1e-12*cos(0.8*2*pi*f1*t) + 8*1e-12*cos(0.36*2*pi*f1*t);

%x = 1*1e-12*cos(2*pi*f1*t) + 0.05*1e-12*cos(3*2*pi*f1*t) + 0.02*1e-12*cos(5*2*pi*f1*t);

%s = 1*cos(2*pi*f1*t) + 0.05*cos(3*2*pi*f1*t) + 0.02*cos(9.46*2*pi*f1*t);
%x = awgn(s,55,'measured');
